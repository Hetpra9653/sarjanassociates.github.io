...
document.addEventListener("DOMContentLoaded", function() {
    if (document.querySelectorAll('.counter').length) {
        document.querySelectorAll('.counter').forEach(function(counter) {
            ...
            var countFrom = 0;
            var duration = 2500; // Duration in milliseconds
            var increment = countTo / (duration / 16); // Assuming 60 frames per second
            var current = countFrom;
            ...
            // Run startCounter when element appears in viewport
            ...
            checkViewport(); // Initial check in case element is already in viewport
        });
    }
});
